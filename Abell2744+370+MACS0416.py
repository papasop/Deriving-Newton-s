...
# Full clean, single-cell Colab script (SciPy tukey 兼容修复版)
# ==========================================================
...
# ---------------- Installs / Imports (含 Tukey 兼容与兜底实现) ----------------
...
try:
    ...
    try:
        from scipy.signal.windows import tukey as tukey_win  # 新路径
    except Exception:
        try:
            from scipy.signal import tukey as tukey_win      # 旧路径
        except Exception:
            raise
